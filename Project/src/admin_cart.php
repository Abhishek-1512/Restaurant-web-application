...
<div>
                        ...
                        <label style="color: red"for="bname" class="labelClass"><b>Name of Burger:</b></label> 
                        <input type="text" placeholder="" name="bname" required><br> <br>
 
                        <strong>     <label style="color: red" for="value"><b>Price of Burger:</b></label> 
                        <input type="text" placeholder="" name="value" required > <br> <br>
 
                        <strong>     <label style="color: red" for="image"><b>Select image of burger:</b></label> 
                        <input style="color:red" type="file" placeholder="" name="image" required > <br> <br>
 
                        <input style="color:red; margin-left:30%;" type="submit" name="add_to_menu"  class="btn btn-success" value="List Add" /> 
                        </form>    
                     </div>
        -->
